export default {
  template: `<div class="form_side">
    ...
    <div class="h4">
        <span></span> <h4>TRACKS</h4><span></span><span></span><span></span>
    </div>
    <div class="container" style="display: block;">
        <div class="rowtable" style="height: 150px;">          
        ...
        <div class="h4">
            <span></span> <h4>ALBUM</h4><span></span><span></span><span></span>
        </div>    
        <div class="rowtable" style="height: 150px;">
  ...
  methods: {
    async searchResults() {
      const res = await fetch(
        `http://localhost:8080/searchresult?query=${this.text}`,
        {
          method: "GET",
          headers: {
      ...
      try {
        ...
        if (res.ok) {
          this.tracks = data.searchtracks;
          this.albums = data.searchalbums;
        } else {
